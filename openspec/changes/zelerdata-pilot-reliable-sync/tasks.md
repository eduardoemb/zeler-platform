...
- [ ] 3.3 Orders worker resume/deduplication/interruption, producer-to-publisher handoff and final coverage verified with actual Mongo and gateway doubles. The pilot worker now has the orders-only protocol enabled behind its flag; one 90-order production interval completed with matching receipts, projection and valid reconciled marker. Other intervals, other resources and twelve-month coverage remain pending.
